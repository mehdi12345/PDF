...
$sql1="SELECT routes FROM donnees;";
$sql="INSERT INTO donnees(billet,passport,soussigne,ne,a,citoyennete,ville,codeone,rue,nr,appartement,conditions,trouve,raisons,adresse,Commun,code,piazza,n,interieur,Aa,transport,type,marque,immatriculation,nameveh,fixe,prive,date) VALUES ('$BILLET','$PASSPORT','$soussigné','$né','$a','$citoyenneté','$ville','$codeone','$rue','$nr','$appartement','$conditions','$trouve','$raisons','$adresse','$Commun','$code','$piazza','$n','$intérieur','$À','$transport','$type','$marque','$immatriculation','$NameVehicule','$fixe','$privé','$date');";
...
<b style='color:blue'>".$row['routes']."</b><br><br>
