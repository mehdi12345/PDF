...
$sql="INSERT INTO donnees VALUES ('$BILLET','$PASSPORT','$soussigné','$né','$a','$citoyenneté','$ville','$codeone','$rue','$nr','$appartement','$route','$transports','$conditions','$trouve','$raisons','$adresse','$Commun','$code','$piazza','$n','$intérieur','$À','$transport','$type','$marque','$immatriculation','$fixe','$privé','$date');";
